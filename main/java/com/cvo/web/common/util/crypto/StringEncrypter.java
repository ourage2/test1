...
public class StringEncrypter {
	...
	public StringEncrypter(String key, String initialVector) throws Exception {
		...
		this.key = new SecretKeySpec(md5.digest(("128".equals(ConfigUtil.getString("aes.encrypt.type")) ? key : key + key).getBytes("UTF8")), "AES");
		this.initalVector = new IvParameterSpec(md5.digest(initialVector.getBytes("UTF8")));
	}

	public StringEncrypter() throws Exception {
		String key = ConfigUtil.getString("aes.encrypt.key");
		String initialVector = key;
