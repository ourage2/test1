...
public class ModelBoxHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter mthodParameter) {
    	...
    	return (ModelBox.class.isAssignableFrom(paramType));
    }
