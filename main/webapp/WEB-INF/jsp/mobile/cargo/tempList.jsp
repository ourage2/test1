...
var user = {
	mainInit: function () {
		...
		com.setCombo('select', srch$, 'srchDevId', null, 'cargo.cdCargoList');
	...
	tempList: function () {
		onm.ajax({
			url: _contextPath_ + '/mobile/cargo/tempList.json',
	...
	makeSeriesData: function (list) {
		...
		var arr = ['ch1', 'ch2', 'ch3', 'ch4', 'ch5', 'ch6'];
		arr.splice(chCnt);
	...
	<div id="divSrch">
		...
		<div class="srch_box" style="display: block">
			<table>
				...
				<tr>
					<th class="state-required">창고</th>
					<td>
						<select name="srchDevId"></select>
					</td>
				</tr>
				<tr>
...
<div id="main" class="main_wrap">
	...
	<table class="m_table">
		...
		<tr>
			...
			<td>{{ last.chCnt > 4 ? last.ch5 : "" }}</td>
			<td>{{ last.chCnt > 5 ? last.ch6 : "" }}</td>
			<td></td>
		</tr>
	</table>
