...
(function($) {
  ...
  Rondell = (function() {
    ...
    Rondell.prototype._start = function() {
      ...
      if (controls.enabled) {
        this.controls._shiftLeft = $("<a href=\"javascript:void(0);\"/>").addClass("" + this.classes.control + " " + this.classes.shiftLeft).html(this.strings.prev).click(this.shiftLeft).css({
          left: controls.margin.x,
          top: controls.margin.y,
          zIndex: this.zIndex + this.maxItems + 2
        });
        this.controls._shiftRight = $("<a href=\"javascript:void(0);\"/>").addClass("" + this.classes.control + " " + this.classes.shiftRight).html(this.strings.next).click(this.shiftRight).css({
